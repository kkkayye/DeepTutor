...
- **CLI** — `/regenerate` (alias `/retry`) inside the `socartes chat` REPL.
...
**Full Changelog**: https://github.com/HKUDS/Socartes/compare/v1.2.0...v1.2.1
