...
Embedding configuration is now explicit about the exact URL Socartes will call.
...
- **Settings now shows Endpoint URL for embeddings** - the Web settings page
  labels embedding URLs as endpoint URLs and explains that Socartes posts to
...
**Full Changelog**: https://github.com/HKUDS/Socartes/compare/v1.3.1...v1.3.2
