...
**Removed `socartes/core` module** - All functionality migrated to `socartes/services`:

| Old Import | New Import |
|:---|:---|
| `from socartes.core.core import load_config_with_main` | `from socartes.services.config import load_config_with_main` |
| `from socartes.core.llm_factory import llm_complete` | `from socartes.services.llm import complete` |
| `from socartes.core.prompt_manager import get_prompt_manager` | `from socartes.services.prompt import get_prompt_manager` |
| `from socartes.core.logging import get_logger` | `from socartes.logging import get_logger` |
...
**Full Changelog**: https://github.com/HKUDS/Socartes/compare/v0.4.0...v0.4.1
