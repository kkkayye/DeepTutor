...
- **Minimal thinking mode is provider-safe** - DeepSeek, DashScope, VolcEngine,
  ...
  `reasoning_effort=minimal`; Socartes sends the provider-specific disable
  signal instead.
...
- **`socartes start` launches the full web stack** - the CLI now delegates to
...
- Added CLI coverage so `socartes start` propagates the launcher exit code.
...
**Full Changelog**: https://github.com/HKUDS/Socartes/compare/v1.3.8...v1.3.9
