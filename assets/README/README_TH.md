...
> **[2026.5.10]** [v1.3.10](https://github.com/HKUDS/Socartes/releases/tag/v1.3.10) — แก้ CORS สำหรับ Docker ระยะไกล, `DISABLE_SSL_VERIFY` ใน SDK providers, citation ใน code block และแยก Matrix E2EE เป็น add-on
