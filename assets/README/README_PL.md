...
# Socartes: Twój spersonalizowany korepetytor oparty na agentach AI
...
[Funkcje](#-kluczowe-funkcje) · [Jak zacząć](#-jak-zacząć) · [Odkrywaj](#-odkrywaj-socartes) · [TutorBoty](#-tutorbot--trwali-autonomiczni-korepetytorzy-ai) · [CLI](#%EF%B8%8F-socartes-cli--interfejs-dla-agentów) · [Multi-użytkownik](#-multi-użytkownik--współdzielone-wdrożenia) · [Roadmapa](#%EF%B8%8F-harmonogram) · [Społeczność](#-społeczność--ekosystem)
...
> **[2026.5.10]** [v1.3.10](https://github.com/HKUDS/Socartes/releases/tag/v1.3.10) — Poprawki CORS dla zdalnego Dockera, `DISABLE_SSL_VERIFY` w providerach SDK, cytowań w blokach kodu oraz Matrix E2EE jako opcjonalny dodatek.

> **[2026.5.9]** [v1.3.9](https://github.com/HKUDS/Socartes/releases/tag/v1.3.9) — TutorBot obsługuje Zulip i NVIDIA NIM, bezpieczniejszy routing modeli rozumujących, `socartes start`, podpowiedzi w pasku bocznym i parytet magazynu sesji.

> **[2026.5.8]** [v1.3.8](https://github.com/HKUDS/Socartes/releases/tag/v1.3.8) — Opcjonalne wdrożenia multi-user z izolowanymi workspace’ami, uprawnieniami admina, trasami auth i scoped runtime access.

> **[2026.5.4]** [v1.3.7](https://github.com/HKUDS/Socartes/releases/tag/v1.3.7) — Poprawki modeli rozumujących/dostawców, widoczna historia indeksu wiedzy, bezpieczniejsze czyszczenie Co-Writer i edycja szablonów.

> **[2026.5.3]** [v1.3.6](https://github.com/HKUDS/Socartes/releases/tag/v1.3.6) — Wybór modeli z katalogu w czacie i TutorBot, bezpieczniejsza ponowna indeksacja RAG, poprawki limitu tokenów OpenAI Responses, walidacja edytora Skills.

> **[2026.5.2]** [v1.3.5](https://github.com/HKUDS/Socartes/releases/tag/v1.3.5) — Płynniejsze ustawienia lokalnego uruchamiania, bezpieczniejsze zapytania RAG, bardziej przejrzyste uwierzytelnianie lokalnych embeddings, dopracowanie trybu ciemnego w Ustawieniach.

> **[2026.5.1]** [v1.3.4](https://github.com/HKUDS/Socartes/releases/tag/v1.3.4) — Trwałość czatu na stronach książki i przepływy przebudowy, odniesienia z czatu do książki, lepsza obsługa języka/rozumowania, wzmocnienie ekstrakcji dokumentów RAG.

> **[2026.4.30]** [v1.3.3](https://github.com/HKUDS/Socartes/releases/tag/v1.3.3) — Obsługa embeddingów NVIDIA NIM i Gemini, ujednolicony kontekst Space dla historii czatu / umiejętności / pamięci, migawki sesji, odporność ponownej indeksacji RAG.

> **[2026.4.29]** [v1.3.2](https://github.com/HKUDS/Socartes/releases/tag/v1.3.2) — Przejrzyste adresy URL endpointów embeddingów, odporność ponownej indeksacji RAG przy nieprawidłowych zapisanych wektorach, czyszczenie pamięci dla wyjścia modeli rozumujących, poprawka runtime Deep Solve.

> **[2026.4.28]** [v1.3.1](https://github.com/HKUDS/Socartes/releases/tag/v1.3.1) — Stabilność: bezpieczniejsze routowanie RAG i walidacja embeddingów, persystencja Docker, bezpieczne wprowadzanie z IME, odporność Windows/GBK.

> **[2026.4.27]** [v1.3.0](https://github.com/HKUDS/Socartes/releases/tag/v1.3.0) — Wersjonowane indeksy KB z przepływem ponownej indeksacji, przebudowana przestrzeń wiedzy, automatyczne wykrywanie embeddingów z nowymi adapterami, hub Space.

<details>
<summary><b>Starsze wydania (ponad 2 tygodnie temu)</b></summary>

> **[2026.4.25]** [v1.2.5](https://github.com/HKUDS/Socartes/releases/tag/v1.2.5) — Trwałe załączniki czatu z szufladą podglądu plików, potoki zdolności świadome załączników, eksport Markdown TutorBot.

> **[2026.4.25]** [v1.2.4](https://github.com/HKUDS/Socartes/releases/tag/v1.2.4) — Załączniki tekst / kod / SVG, konfiguracja jednym poleceniem, eksport czatu Markdown, zwarty interfejs zarządzania KB.

> **[2026.4.24]** [v1.2.3](https://github.com/HKUDS/Socartes/releases/tag/v1.2.3) — Załączniki dokumentów (PDF/DOCX/XLSX/PPTX), blok rozumowania modelu, edytor szablonów Soul, zapis z Co-Writer do notesu.

> **[2026.4.22]** [v1.2.2](https://github.com/HKUDS/Socartes/releases/tag/v1.2.2) — System Skills tworzonych przez użytkownika, optymalizacja wydajności wpisywania w czacie, autostart TutorBot, UI biblioteki książek, wizualizacje pełnoekranowe.

> **[2026.4.21]** [v1.2.1](https://github.com/HKUDS/Socartes/releases/tag/v1.2.1) — Limity tokenów na etap, ponowna generacja odpowiedzi we wszystkich punktach wejścia, poprawki zgodności RAG i Gemma.

> **[2026.4.20]** [v1.2.0](https://github.com/HKUDS/Socartes/releases/tag/v1.2.0) — Kompilator Book Engine „żywych książek", Co-Writer wielodokumentowy, interaktywne wizualizacje HTML, @-wzmianki banku pytań na czacie.

> **[2026.4.18]** [v1.1.2](https://github.com/HKUDS/Socartes/releases/tag/v1.1.2) — Zakładka Channels oparta na schemacie, konsolidacja RAG w jednym potoku, zewnętrzne prompty czatu.

> **[2026.4.17]** [v1.1.1](https://github.com/HKUDS/Socartes/releases/tag/v1.1.1) — Uniwersalne „Odpowiedz teraz", synchronizacja przewijania Co-Writer, zunifikowany panel ustawień, przycisk Stop przy strumieniowaniu.

> **[2026.4.15]** [v1.1.0](https://github.com/HKUDS/Socartes/releases/tag/v1.1.0) — Przepisanie parsera bloków matematycznych LaTeX, diagnostyka LLM przez `agents.yaml`, naprawa przekazywania nagłówków HTTP, wskazówki dla Docker + lokalne LLM.

> **[2026.4.14]** [v1.1.0-beta](https://github.com/HKUDS/Socartes/releases/tag/v1.1.0-beta) — Sesje zapisywane w zakładkach, nowy motyw Snow, heartbeat i automatyczne wznawianie WebSocket, przebudowa rejestru embeddings, integracja z Serper.

> **[2026.4.13]** [v1.0.3](https://github.com/HKUDS/Socartes/releases/tag/v1.0.3) — Notatnik na pytania z zakładkami i kategoriami, Mermaid w Wizualizacjach, wykrywanie niedopasowania embeddings, kompatybilność Qwen/vLLM, LM Studio i llama.cpp, motyw Glass.

> **[2026.4.11]** [v1.0.2](https://github.com/HKUDS/Socartes/releases/tag/v1.0.2) — Ujednolicenie wyszukiwania z fallbackiem do SearXNG, naprawa przełączania dostawców, łatki na wycieki pamięci we frontendzie.

> **[2026.4.10]** [v1.0.1](https://github.com/HKUDS/Socartes/releases/tag/v1.0.1) — Funkcja Wizualizacji (Chart.js/SVG), zapobieganie powtarzaniu pytań w quizach, obsługa modelu o4-mini.

> **[2026.4.10]** [v1.0.0-beta.4](https://github.com/HKUDS/Socartes/releases/tag/v1.0.0-beta.4) — Śledzenie postępu wektoryzacji z automatycznym ponawianiem, wieloplatformowe poprawki zależności, naprawa walidacji typów MIME.

> **[2026.4.8]** [v1.0.0-beta.3](https://github.com/HKUDS/Socartes/releases/tag/v1.0.0-beta.3) — Przejście na natywne SDK OpenAI i Anthropic (rezygnacja z litellm), obsługa Math Animator dla Windows, niezawodne parsowanie JSON, pełne tłumaczenie na chiński.

> **[2026.4.7]** [v1.0.0-beta.2](https://github.com/HKUDS/Socartes/releases/tag/v1.0.0-beta.2) — Przeładowywanie ustawień w locie, zagnieżdżone wyniki z MinerU, łatki dla WebSocketów, podniesienie wymagań do Pythona 3.11+.

> **[2026.4.4]** [v1.0.0-beta.1](https://github.com/HKUDS/Socartes/releases/tag/v1.0.0-beta.1) — Całkowicie nowa architektura oparta na agentach (~200 tys. linii kodu): system wtyczek Tools + Capabilities, nowe CLI i SDK, TutorBot, Co-Writer, Guided Learning, długoterminowa pamięć.

> **[2026.1.23]** [v0.6.0](https://github.com/HKUDS/Socartes/releases/tag/v0.6.0) — Pamięć sesji, przyrostowe przesyłanie dokumentów, elastyczny import do RAG, pełne wsparcie języka chińskiego.

> **[2026.1.18]** [v0.5.2](https://github.com/HKUDS/Socartes/releases/tag/v0.5.2) — Integracja z Docling (RAG-Anything), optymalizacja logów, paczka mniejszych poprawek.

> **[2026.1.15]** [v0.5.0](https://github.com/HKUDS/Socartes/releases/tag/v0.5.0) — Centralna konfiguracja usług, wybór potoku RAG dla każdej bazy wiedzy, przebudowa generowania pytań, personalizacja paska bocznego.

> **[2026.1.9]** [v0.4.0](https://github.com/HKUDS/Socartes/releases/tag/v0.4.0) — Wsparcie dla wielu dostawców LLM i embeddingów, nowa strona główna, wydzielenie RAG, porządkowanie zmiennych środowiskowych.

> **[2026.1.5]** [v0.3.0](https://github.com/HKUDS/Socartes/releases/tag/v0.3.0) — Zunifikowana architektura PromptManager, wdrożenie CI/CD przez GitHub Actions, gotowe obrazy Dockera w GHCR.

> **[2026.1.2]** [v0.2.0](https://github.com/HKUDS/Socartes/releases/tag/v0.2.0) — Wdrożenie w Dockerze, aktualizacja do Next.js 16 i React 19, zabezpieczenie WebSocketów, krytyczne łatki bezpieczeństwa.
...
> **[2026.4.10]** 📄 Nasz artykuł jest już na arXiv! Przeczytaj [preprint](https://arxiv.org/abs/2604.26962), aby poznać założenia i idee stojące za Socartes.

> **[2026.4.4]** Doczekaliśmy się! ✨ Socartes v1.0.0 jest już dostępny — ewolucja w kierunku architektury agentowej, przebudowana od podstaw, z TutorBotami i płynnym przełączaniem trybów na licencji Apache-2.0.

> **[2026.2.6]** 🚀 Mamy 10 000 gwiazdek w zaledwie 39 dni! Ogromne podziękowania dla naszej społeczności.

> **[2026.1.1]** Szczęśliwego Nowego Roku! Wpadnij na naszego [Discorda](https://discord.gg/eRsjPgMU4t), [WeChat](https://github.com/HKUDS/Socartes/issues/78) lub dołącz do [Dyskusji](https://github.com/HKUDS/Socartes/discussions).

> **[2025.12.29]** Oficjalnie wystartowaliśmy! Pierwsze wydanie Socartes ujrzało światło dzienne.
...
- **Długoterminowa Pamięć** — Socartes buduje Twój profil: czego się uczyłeś, jak uczysz, dokąd zmierzasz. Pamięć jest współdzielona przez wszystkie funkcje i TutorBoty.
...
```yaml
image: ghcr.io/hkuds/socartes:1.3.4  # lub :latest
```
...
Zmiany w `socartes/`, `socartes_cli/`, `scripts/` i `web/` są odzwierciedlane natychmiast.
...
```bash
socartes chat                                   # Interaktywny REPL
socartes run chat "Explain Fourier transform"   # Jednorazowe wywołanie
socartes run deep_solve "Solve x^2 = 4"         # Rozwiązywanie wieloagentowe
socartes kb create my-kb --doc textbook.pdf     # Utwórz bazę wiedzy
```
...
<div align="center">
<img src="../../assets/figs/socartes-architecture.png" alt="Architektura Socartes" width="800">
</div>
...
Podaj temat i wskaż bazę wiedzy — Socartes tworzy strukturyzowaną, interaktywną książkę. Pipeline wieloagentowy proponuje zarys, pobiera źródła, planuje strony i kompiluje bloki. Ty kontrolujesz: przeglądasz propozycję, zmieniasz kolejność rozdziałów, rozmawiasz przy dowolnej stronie.
...
### 🧠 Pamięć — Socartes uczy się razem z Tobą
...
Pamięć jest współdzielona przez wszystkie funkcje i TutorBoty. Im więcej używasz, tym bardziej spersonalizowany staje się Socartes.
...
socartes bot list                  # Zobacz wszystkich aktywnych tutorów
```

---

### ⌨️ Socartes CLI — Interfejs dla agentów

<div align="center">
<img src="../../assets/figs/cli-architecture.png" alt="Architektura Socartes CLI" width="800">
</div>

Socartes jest w pełni natywny dla CLI. Każda funkcja, baza wiedzy, sesja i TutorBot jednym poleceniem — bez przeglądarki. Przekaż [`SKILL.md`](../../SKILL.md) agentowi ([nanobot](https://github.com/HKUDS/nanobot)), a będzie operować Socartes autonomicznie.

```bash
socartes run chat "Explain the Fourier transform" -t rag --kb textbook
socartes run deep_solve "Prove that sqrt(2) is irrational" -t reason
...
socartes kb add my-kb --docs-dir ./papers/
socartes kb search my-kb "gradient descent"
socartes kb set-default my-kb
```

```bash
socartes run chat "Summarize chapter 3" -f rich
socartes run chat "Summarize chapter 3" -f json
```

```bash
socartes session list
socartes session open <id>
```
...
| Polecenie | Opis |
|:---|:---|
| `socartes run <capability> <message>` | Uruchom funkcję w jednej turze (`chat`, `deep_solve`, `deep_question`, `deep_research`, `math_animator`, `visualize`) |
| `socartes chat` | Interaktywny REPL (`--capability`, `--tool`, `--kb`, `--language`) |
| `socartes serve` | Uruchom serwer API Socartes |

**`socartes bot`**

| Polecenie | Opis |
|:---|:---|
| `socartes bot list` | Lista instancji TutorBot |
| `socartes bot create <id>` | Utwórz i uruchom bota (`--name`, `--persona`, `--model`) |
| `socartes bot start <id>` | Uruchom bota |
| `socartes bot stop <id>` | Zatrzymaj bota |

**`socartes kb`**

| Polecenie | Opis |
|:---|:---|
| `socartes kb list` | Lista baz wiedzy |
| `socartes kb info <name>` | Szczegóły bazy wiedzy |
| `socartes kb create <name>` | Utwórz z dokumentów (`--doc`, `--docs-dir`) |
| `socartes kb add <name>` | Dodaj dokumenty |
| `socartes kb search <name> <query>` | Przeszukaj bazę wiedzy |
| `socartes kb set-default <name>` | Ustaw jako domyślną KB |
| `socartes kb delete <name>` | Usuń bazę wiedzy (`--force`) |

**`socartes memory`**

| Polecenie | Opis |
|:---|:---|
| `socartes memory show [file]` | Wyświetl pamięć (`summary`, `profile`, `all`) |
| `socartes memory clear [file]` | Wyczyść pamięć (`--force`) |

**`socartes session`**

| Polecenie | Opis |
|:---|:---|
| `socartes session list` | Lista sesji (`--limit`) |
| `socartes session show <id>` | Komunikaty sesji |
| `socartes session open <id>` | Wznów sesję w REPL |
| `socartes session rename <id>` | Zmień nazwę sesji (`--title`) |
| `socartes session delete <id>` | Usuń sesję |

**`socartes notebook`**

| Polecenie | Opis |
|:---|:---|
| `socartes notebook list` | Lista notatników |
| `socartes notebook create <name>` | Utwórz notatnik (`--description`) |
| `socartes notebook show <id>` | Rekordy notatnika |
| `socartes notebook add-md <id> <path>` | Importuj Markdown jako rekord |
| `socartes notebook replace-md <id> <rec> <path>` | Zastąp rekord Markdown |
| `socartes notebook remove-record <id> <rec>` | Usuń rekord |

**`socartes book`**

| Polecenie | Opis |
|:---|:---|
| `socartes book list` | Lista wszystkich książek w workspace |
| `socartes book health <book_id>` | Sprawdź dryft KB i stan książki |
| `socartes book refresh-fingerprints <book_id>` | Odśwież odciski palców KB |

**`socartes config` / `plugin` / `provider`**

| Polecenie | Opis |
|:---|:---|
| `socartes config show` | Podsumowanie konfiguracji |
| `socartes plugin list` | Zarejestrowane narzędzia i funkcje |
| `socartes plugin info <name>` | Szczegóły narzędzia |
| `socartes provider login <provider>` | Uwierzytelnienie dostawcy (`openai-codex` OAuth; `github-copilot` weryfikuje sesję Copilot) |
...
Włącz uwierzytelnianie, a Socartes staje się wdrożeniem multi-tenant z **izolowanymi workspace'ami per-użytkownik** i **zasobami kurowanymi przez admina**. Pierwsza zarejestrowana osoba zostaje adminem i konfiguruje modele, klucze API i bazy wiedzy dla wszystkich. Kolejne konta tworzy admin (tylko na zaproszenie), każdy dostaje scoped historię czatu/pamięć/notatniki/bazy wiedzy.
...
> Jeśli Socartes jest przydatny, [przyznaj nam gwiazdkę](https://github.com/HKUDS/Socartes/stargazers)!

---

## 🌐 Społeczność i ekosystem

| Projekt | Rola w Socartes |
|:---|:---|
...
Mamy nadzieję, że Socartes stanie się prezentem dla społeczności. 🎁
...
[⭐ Oznacz nas gwiazdką](https://github.com/HKUDS/Socartes/stargazers) · [🐛 Zgłoś błąd](https://github.com/HKUDS/Socartes/issues) · [💬 Dyskusje](https://github.com/HKUDS/Socartes/discussions)
