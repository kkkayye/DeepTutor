...
# Socartes: tutoria personalizada nativa para agentes
...
[Recursos](#key-features) · [Começar](#get-started) · [Explorar](#explore-socartes) · [TutorBot](#tutorbot) · [CLI](#socartes-cli-guide) · [Roteiro](#roadmap) · [Comunidade](#community)
...
> **[2026.5.10]** [v1.3.10](https://github.com/HKUDS/Socartes/releases/tag/v1.3.10) — Correção de CORS em Docker remoto, `DISABLE_SSL_VERIFY` nos provedores SDK, citações seguras em blocos de código e E2EE do Matrix como add-on opcional.

> **[2026.5.9]** [v1.3.9](https://github.com/HKUDS/Socartes/releases/tag/v1.3.9) — TutorBot com Zulip e NVIDIA NIM, roteamento mais seguro para modelos de raciocínio, `socartes start`, tooltips na barra lateral e paridade do store de sessões.

> **[2026.5.8]** [v1.3.8](https://github.com/HKUDS/Socartes/releases/tag/v1.3.8) — Deploys multiusuário opcionais com workspaces isolados, concessões de admin, rotas de autenticação e acesso runtime com escopo.

> **[2026.5.4]** [v1.3.7](https://github.com/HKUDS/Socartes/releases/tag/v1.3.7) — Correções de modelos de raciocínio/provedores, histórico de índice de conhecimento visível e edição de templates e limpeza do Co-Writer mais seguros.

> **[2026.5.3]** [v1.3.6](https://github.com/HKUDS/Socartes/releases/tag/v1.3.6) — Seleção de modelos por catálogo no chat e TutorBot, reindexação RAG mais segura, correções de limite de tokens do OpenAI Responses e validação do editor Skills.

> **[2026.5.2]** [v1.3.5](https://github.com/HKUDS/Socartes/releases/tag/v1.3.5) — Configurações de lançamento local mais fluidas, consultas RAG mais seguras, autenticação de embedding local mais clara e polimento do modo escuro das Configurações.

> **[2026.5.1]** [v1.3.4](https://github.com/HKUDS/Socartes/releases/tag/v1.3.4) — Persistência de chat em página de livro e fluxos de reconstrução, referências de chat para livro, melhor tratamento de idioma/raciocínio, endurecimento da extração de documentos RAG.

> **[2026.4.30]** [v1.3.3](https://github.com/HKUDS/Socartes/releases/tag/v1.3.3) — Suporte a embeddings NVIDIA NIM e Gemini, contexto Space unificado para histórico do chat / skills / memória, instantâneos de sessão, resiliência de reindexação RAG.

> **[2026.4.29]** [v1.3.2](https://github.com/HKUDS/Socartes/releases/tag/v1.3.2) — URLs de endpoint de embedding transparentes, resiliência de reindexação RAG para vetores persistidos inválidos, limpeza de memória para saída de modelos de raciocínio, correção de runtime do Deep Solve.

> **[2026.4.28]** [v1.3.1](https://github.com/HKUDS/Socartes/releases/tag/v1.3.1) — Estabilidade: roteamento RAG mais seguro e validação de embeddings, persistência Docker, entrada segura com IME, robustez Windows/GBK.

> **[2026.4.27]** [v1.3.0](https://github.com/HKUDS/Socartes/releases/tag/v1.3.0) — Índices KB versionados com fluxo de reindexação, espaço de conhecimento reconstruído, autodetecção de embeddings com novos adaptadores, hub Space.

<details>
<summary><b>Lançamentos anteriores (há mais de 2 semanas)</b></summary>

> **[2026.4.25]** [v1.2.5](https://github.com/HKUDS/Socartes/releases/tag/v1.2.5) — Anexos de chat persistentes com gaveta de pré-visualização, pipelines de capacidade cientes de anexos, exportação Markdown do TutorBot.

> **[2026.4.25]** [v1.2.4](https://github.com/HKUDS/Socartes/releases/tag/v1.2.4) — Anexos de texto / código / SVG, tour de configuração em um comando, exportação do chat Markdown, UI compacta de gestão de KB.

> **[2026.4.24]** [v1.2.3](https://github.com/HKUDS/Socartes/releases/tag/v1.2.3) — Anexos de documentos (PDF/DOCX/XLSX/PPTX), exibição do bloco de raciocínio, editor de modelos Soul, salvar no caderno a partir do Co-Writer.

> **[2026.4.22]** [v1.2.2](https://github.com/HKUDS/Socartes/releases/tag/v1.2.2) — Skills criados pelo usuário, melhoria de desempenho do input de chat, início automático do TutorBot, UI da biblioteca de livros, visualização em tela cheia.

> **[2026.4.21]** [v1.2.1](https://github.com/HKUDS/Socartes/releases/tag/v1.2.1) — Limites de tokens por etapa, regenerar resposta em todos os pontos de entrada, correções de compatibilidade RAG e Gemma.

> **[2026.4.20]** [v1.2.0](https://github.com/HKUDS/Socartes/releases/tag/v1.2.0) — Compilador Book Engine de «livros vivos», Co-Writer multidocumento, visualizações HTML interativas, menções @ do banco de questões no chat.

> **[2026.4.18]** [v1.1.2](https://github.com/HKUDS/Socartes/releases/tag/v1.1.2) — Aba Channels orientada por schema, consolidação RAG em pipeline único, prompts de chat externalizados.

> **[2026.4.17]** [v1.1.1](https://github.com/HKUDS/Socartes/releases/tag/v1.1.1) — «Responder agora» universal, sincronização de rolagem no Co-Writer, painel de configurações unificado, botão Stop em streaming.

> **[2026.4.15]** [v1.1.0](https://github.com/HKUDS/Socartes/releases/tag/v1.1.0) — Reformulação do parsing de LaTeX em bloco; sonda de diagnóstico LLM via `agents.yaml`; correção do encaminhamento de cabeçalhos extras; correção de UUID no SaveToNotebook; guia Docker + LLM local.

> **[2026.4.14]** [v1.1.0-beta](https://github.com/HKUDS/Socartes/releases/tag/v1.1.0-beta) — Sessões com URL marcável; tema Snow; heartbeat WebSocket e reconexão automática; desempenho do ChatComposer; reformulação do registro de provedores de embeddings; provedor de busca Serper.

> **[2026.4.13]** [v1.0.3](https://github.com/HKUDS/Socartes/releases/tag/v1.0.3) — Caderno de questões com favoritos e categorias; Mermaid no Visualize; detecção de incompatibilidade de embeddings; compatibilidade Qwen/vLLM; suporte LM Studio e llama.cpp; tema Glass.

> **[2026.4.11]** [v1.0.2](https://github.com/HKUDS/Socartes/releases/tag/v1.0.2) — Consolidação de busca com fallback SearXNG; correção da troca de provedor; vazamentos de recursos no frontend.

> **[2026.4.10]** [v1.0.1](https://github.com/HKUDS/Socartes/releases/tag/v1.0.1) — Capacidade Visualize (Chart.js/SVG); prevenção de duplicatas em questionários; suporte ao modelo o4-mini.

> **[2026.4.10]** [v1.0.0-beta.4](https://github.com/HKUDS/Socartes/releases/tag/v1.0.0-beta.4) — Acompanhamento de embeddings com nova tentativa sob limite de taxa; dependências multiplataforma; validação MIME.

> **[2026.4.8]** [v1.0.0-beta.3](https://github.com/HKUDS/Socartes/releases/tag/v1.0.0-beta.3) — SDK nativo OpenAI/Anthropic (sem litellm); Math Animator no Windows; parsing JSON mais robusto; i18n chinês completo.

> **[2026.4.7]** [v1.0.0-beta.2](https://github.com/HKUDS/Socartes/releases/tag/v1.0.0-beta.2) — Recarga a quente de configurações; saída aninhada MinerU; correção WebSocket; mínimo Python 3.11+.

> **[2026.4.4]** [v1.0.0-beta.1](https://github.com/HKUDS/Socartes/releases/tag/v1.0.0-beta.1) — Reescrita nativa de agentes (~200k linhas): plugins Tools + Capabilities, CLI e SDK, TutorBot, Co-Writer, aprendizado guiado e memória persistente.

> **[2026.1.23]** [v0.6.0](https://github.com/HKUDS/Socartes/releases/tag/v0.6.0) — Persistência de sessão, upload incremental, RAG flexível, localização em chinês.

> **[2026.1.18]** [v0.5.2](https://github.com/HKUDS/Socartes/releases/tag/v0.5.2) — Docling, logs, correções.

> **[2026.1.15]** [v0.5.0](https://github.com/HKUDS/Socartes/releases/tag/v0.5.0) — Config unificada, RAG por KB, geração de questões, barra lateral.

> **[2026.1.9]** [v0.4.0](https://github.com/HKUDS/Socartes/releases/tag/v0.4.0) — Multi-provedor LLM/embeddings, nova home, desacoplamento RAG, variáveis de ambiente.

> **[2026.1.5]** [v0.3.0](https://github.com/HKUDS/Socartes/releases/tag/v0.3.0) — PromptManager, CI/CD, imagens GHCR.

> **[2026.1.2]** [v0.2.0](https://github.com/HKUDS/Socartes/releases/tag/v0.2.0) — Docker, Next.js 16 e React 19, WebSocket, vulnerabilidades.
...
> **[2026.4.10]** 📄 Nosso artigo está no arXiv! Leia o [preprint](https://arxiv.org/abs/2604.26962) para conhecer o desenho e as ideias por trás do Socartes.

> **[2026.4.4]** Há quanto tempo! ✨ Socartes v1.0.0 chegou — evolução nativa de agentes com reescrita da arquitetura do zero, TutorBot e modos flexíveis sob Apache-2.0. Um novo capítulo começa!

> **[2026.2.6]** 🚀 10k estrelas em 39 dias — obrigado à comunidade!

> **[2026.1.1]** Feliz Ano Novo! Junte-se ao [Discord](https://discord.gg/eRsjPgMU4t), [WeChat](https://github.com/HKUDS/Socartes/issues/78) ou [Discussions](https://github.com/HKUDS/Socartes/discussions).

> **[2025.12.29]** Socartes é lançado oficialmente.
...
# Socartes com dependências de backend + servidor web
...
As imagens oficiais são publicadas no [GitHub Container Registry](https://github.com/HKUDS/Socartes/pkgs/container/socartes) a cada release, para `linux/amd64` e `linux/arm64`.
...
```yaml
image: ghcr.io/hkuds/socartes:1.0.0  # ou :latest
```
...
Alterações em `socartes/`, `socartes_cli/`, `scripts/` e `web/` refletem-se imediatamente.
...
socartes run deep_solve "Solve x^2 = 4"
socartes kb create my-kb --doc textbook.pdf
```

> Guia completo: [Socartes CLI](#socartes-cli-guide).
...
<div align="center">
<img src="../../assets/figs/socartes-architecture.png" alt="Arquitetura Socartes" width="800">
</div>
...
Dê um tema, aponte para a sua base de conhecimento: o Socartes produz um livro estruturado e interativo — documento vivo para ler, autoavaliar e discutir em contexto.
...
<a id="socartes-cli-guide"></a>
### ⌨️ Socartes CLI — Interface nativa para agentes
...
| Comando | Descrição |
|:---|:---|
| `socartes run <capability> <message>` | Executa uma capacidade em um turno (`chat`, `deep_solve`, `deep_question`, `deep_research`, `math_animator`, `visualize`) |
| `socartes chat` | REPL interativo com `--capability`, `--tool`, `--kb`, `--language`, etc. |
| `socartes serve` | Inicia o servidor API do Socartes |

**`socartes bot`**

| Comando | Descrição |
|:---|:---|
| `socartes bot list` | Lista instâncias do TutorBot |
| `socartes bot create <id>` | Cria e inicia um bot (`--name`, `--persona`, `--model`) |
| `socartes bot start <id>` | Inicia um bot |
| `socartes bot stop <id>` | Para um bot |

**`socartes kb`**

| Comando | Descrição |
|:---|:---|
| `socartes kb list` | Lista bases de conhecimento |
| `socartes kb info <name>` | Detalhes da base |
| `socartes kb create <name>` | Cria a partir de documentos (`--doc`, `--docs-dir`) |
| `socartes kb add <name>` | Adiciona documentos |
| `socartes kb search <name> <query>` | Busca na base |
| `socartes kb set-default <name>` | Define KB padrão |
| `socartes kb delete <name>` | Remove (`--force`) |

**`socartes memory`**

| Comando | Descrição |
|:---|:---|
| `socartes memory show [file]` | Ver (`summary`, `profile`, `all`) |
| `socartes memory clear [file]` | Limpar (`--force`) |

**`socartes session`**

| Comando | Descrição |
|:---|:---|
| `socartes session list` | Lista sessões (`--limit`) |
| `socartes session show <id>` | Mensagens da sessão |
| `socartes session open <id>` | Retomar no REPL |
| `socartes session rename <id>` | Renomear (`--title`) |
| `socartes session delete <id>` | Excluir |

**`socartes notebook`**

| Comando | Descrição |
|:---|:---|
| `socartes notebook list` | Lista cadernos |
| `socartes notebook create <name>` | Criar (`--description`) |
| `socartes notebook show <id>` | Registros |
| `socartes notebook add-md <id> <path>` | Importar Markdown |
| `socartes notebook replace-md <id> <rec> <path>` | Substituir registro |
| `socartes notebook remove-record <id> <rec>` | Remover registro |

**`socartes book`**

| Comando | Descrição |
|:---|:---|
| `socartes book list` | Lista todos os livros do espaço de trabalho |
| `socartes book health <book_id>` | Verifica deriva da KB e saúde do livro |
| `socartes book refresh-fingerprints <book_id>` | Atualiza impressões digitais da KB e limpa páginas obsoletas |

**`socartes config` / `plugin` / `provider`**

| Comando | Descrição |
|:---|:---|
| `socartes config show` | Resumo da configuração |
| `socartes plugin list` | Ferramentas e capacidades registradas |
| `socartes plugin info <name>` | Detalhe de ferramenta ou capacidade |
| `socartes provider login <provider>` | Autenticação do provedor (OAuth com `openai-codex`; `github-copilot` valida uma sessão Copilot existente) |
...
> Se o Socartes for útil para você, [dê uma estrela](https://github.com/HKUDS/Socartes/stargazers) — isso nos ajuda a continuar!
...
Esperamos que o Socartes seja um presente para a comunidade. 🎁
...
<a href="https://www.star-history.com/#HKUDS/Socartes&type=timeline&legend=top-left">
  <picture>
    ...
    <img alt="Star History" src="https://api.star-history.com/svg?repos=HKUDS/Socartes&type=timeline&legend=top-left" />
  </picture>
</a>
</div>
...
[⭐ Star](https://github.com/HKUDS/Socartes/stargazers) · [🐛 Issues](https://github.com/HKUDS/Socartes/issues) · [💬 Discussions](https://github.com/HKUDS/Socartes/discussions)
