...
const SPLIT_RATIO_KEY = "socartes.co_writer.split_ratio";
const SYNC_SCROLL_KEY = "socartes.co_writer.sync_scroll";
const LOCAL_DRAFT_PREFIX = "socartes.co_writer.draft.";
