...
def _load_embedding_services():
    from socartes.services.embedding.client import get_embedding_client, reset_embedding_client
    from socartes.services.embedding.config import get_embedding_config
