...
Migrate existing knowledge bases into Socartes's knowledge base system.
...
async def migrate_kb(
    ...
    """
    Migrate a knowledge base to Socartes.
    ...
    print(f"  Knowledge base '{kb_name}' is now available in Socartes.")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Migrate knowledge bases into Socartes",
