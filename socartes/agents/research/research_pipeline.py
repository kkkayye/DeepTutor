...
from socartes.agents.research.agents import (
    DecomposeAgent,
    ManagerAgent,
    NoteAgent,
    RephraseAgent,
...
from socartes.agents.research.data_structures import DynamicTopicQueue
from socartes.agents.research.utils.citation_manager import CitationManager
from socartes.core.trace import new_call_id
from socartes.runtime.registry.tool_registry import get_tool_registry
from socartes.services.config import PROJECT_ROOT
...
class ResearchPipeline:
    ...
    async def run(self, topic: str) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                from socartes.agents.research.utils.token_tracker import get_token_tracker
    ...
    async def _phase2_researching_parallel(self):
        ...
        from socartes.agents.research.data_structures import TopicStatus
...
async def main():
    ...
    from socartes.services.llm import get_llm_config
