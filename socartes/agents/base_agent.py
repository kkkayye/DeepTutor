...
from socartes.config.settings import settings
from socartes.logging import LLMStats
from socartes.services.config import get_agent_params
...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f"socartes.{logger_name}")
