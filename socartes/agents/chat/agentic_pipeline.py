...
from socartes.core.trace import (
...
from socartes.services.config import get_chat_params
from socartes.services.llm import (
    clean_thinking_tags,
    get_llm_config,
...
from socartes.services.prompt import get_prompt_manager
from socartes.services.prompt.language import append_language_directive
from socartes.tools.builtin import BUILTIN_TOOL_NAMES
from socartes.utils.json_parser import parse_json_response
...
class AgenticChatPipeline:
    ...
    def __init__(self, language: str = "en") -> None:
        ...
        # Prompts live in socartes/agents/chat/prompts/{zh,en}/agentic_chat.yaml
    ...
    def _extract_answer_now_context(context: UnifiedContext) -> dict[str, Any] | None:
        ...
        from socartes.capabilities._answer_now import extract_answer_now_context
