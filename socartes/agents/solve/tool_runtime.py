...
from socartes.runtime.registry.tool_registry import ToolRegistry as CoreToolRegistry
from socartes.runtime.registry.tool_registry import get_tool_registry

if TYPE_CHECKING:
    from socartes.core.tool_protocol import ToolResult
...
class SolveToolRuntime:
    ...
    async def execute(
        ...
        *,
        ...
        from socartes.core.tool_protocol import ToolResult as _ToolResult
