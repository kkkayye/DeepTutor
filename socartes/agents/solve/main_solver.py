...
from socartes.core.trace import derive_trace_metadata, new_call_id
...
class MainSolver:
    ...
    def __init__(
        ...
        self.logger: logging.Logger = logging.getLogger("socartes.Solver")
    ...
    async def _load_config(self) -> None:
        ...
        from socartes.services.llm import is_local_llm_server
    ...
    def _init_logging(self) -> None:
        ...
        self.logger = logging.getLogger("socartes.Solver")
