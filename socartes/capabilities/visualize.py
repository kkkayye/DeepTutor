...
from socartes.core.trace import merge_trace_metadata
...
class VisualizeCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        from socartes.agents.visualize.pipeline import VisualizePipeline
        from socartes.agents.visualize.utils import (
            build_fallback_html,
        ...
        async with stream.stage("reviewing", source=self.name):
            if analysis.render_type == "html":
                ...
                from socartes.agents.visualize.models import ReviewResult
