...
Unified service layer for Socartes providing:
...
Usage:
    ...
    from socartes.services.embedding import get_embedding_client
    from socartes.services.rag import RAGService
    ...
    from socartes.services.config import load_config_with_main
