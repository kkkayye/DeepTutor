...
file via the :mod:`socartes.api.routers.attachments` endpoint to render a
preview.
...
from socartes.tutorbot.utils.helpers import safe_filename
...
# Public route prefix served by socartes.api.routers.attachments
