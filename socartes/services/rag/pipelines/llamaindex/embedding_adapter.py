"""LlamaIndex embedding adapter backed by Socartes's embedding service."""
...
from socartes.services.embedding import EmbeddingConfig, get_embedding_client, get_embedding_config
...
class CustomEmbedding(BaseEmbedding):
    """Custom LlamaIndex embedding adapter for Socartes embedding providers."""
...
def configure_llamaindex_settings(logger=None) -> None:
    """Configure LlamaIndex globals for Socartes's current embedding config."""
