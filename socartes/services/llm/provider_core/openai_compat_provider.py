...
from socartes.services.llm.openai_http_client import openai_client_kwargs
from socartes.services.llm.provider_core.base import LLMProvider, LLMResponse, ToolCallRequest
from socartes.services.llm.provider_core.openai_responses import (
...
if TYPE_CHECKING:
    from socartes.services.provider_registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/HKUDS/Socartes",
    "X-OpenRouter-Title": "Socartes",
}
