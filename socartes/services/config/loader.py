...
Unified configuration loading for all Socartes modules.
...
# PROJECT_ROOT points to the actual project root directory (Socartes/)
# Path(__file__) = socartes/services/config/loader.py
# .parent = socartes/services/config/
# .parent.parent = socartes/services/
# .parent.parent.parent = socartes/
# .parent.parent.parent.parent = Socartes/ (project root)
...
def parse_language(language: Any) -> str:
    ...
    Args:
        language: Language configuration value (can be "zh"/"en"/"ko"/"Chinese"/"English" etc.)

    Returns:
        Standardized language code: 'zh', 'en', or 'ko', defaults to 'zh'
    """
    if not language:
        return "zh"
