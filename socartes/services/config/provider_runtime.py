"""Nanobot-style normalized runtime configuration for Socartes."""
...
from socartes.services.model_selection import LLMSelection, apply_llm_selection_to_catalog
from socartes.services.provider_registry import (
