...
from socartes.core.capability_protocol import BaseCapability
from socartes.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_CLASSES
...
def _load_plugin_hooks():
    try:
        module = importlib.import_module("socartes.plugins.loader")
    except Exception:
