...
_CONFIGURED = False
_MANAGED_ATTR = "_socartes_managed"
...
def configure_logging(force: bool = False) -> LoggingConfig:
    ...
    logging.getLogger("socartes").setLevel(logging.DEBUG)
    logging.getLogger("socartes").propagate = True
