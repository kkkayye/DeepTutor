---
name: knowledge-base
description: "Manage Socartes knowledge bases — list, create, search, add documents, delete."
...
Use the `exec` tool to manage Socartes knowledge bases via CLI.
...
```bash
socartes kb info <kb_name>
```

### Create a knowledge base

```bash
socartes kb create <kb_name> --doc /path/to/file.pdf
socartes kb create <kb_name> --docs-dir /path/to/directory/
```

### Add documents to existing KB

```bash
socartes kb add <kb_name> --doc /path/to/new_file.pdf
```

### Search a knowledge base

```bash
socartes kb search <kb_name> "<query>" --format json
```

### Set a default knowledge base

```bash
socartes kb set-default <kb_name>
```

### Delete a knowledge base

```bash
socartes kb delete <kb_name> --force
```
