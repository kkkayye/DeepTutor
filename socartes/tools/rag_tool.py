...
All logic is delegated to RAGService in socartes/services/rag/service.py.
"""
...
from socartes.services.rag.service import DEFAULT_KB_BASE_DIR, RAGService
    ...
    **kwargs,
    ...
    if kb_base_dir is None:
        try:
            ...
            from socartes.multi_user.knowledge_access import resolve_for_rag
