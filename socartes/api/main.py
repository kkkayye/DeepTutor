...
from socartes.logging import configure_logging
...
def validate_tool_consistency():
    ...
    """
    try:
        from socartes.runtime.registry.capability_registry import get_capability_registry
        from socartes.runtime.registry.tool_registry import get_tool_registry
...
async def lifespan(app: FastAPI):
    ...
    try:
        from socartes.services.llm import get_llm_client
    ...
    try:
        from socartes.events.event_bus import get_event_bus
    ...
    try:
        from socartes.services.tutorbot import get_tutorbot_manager
    ...
    try:
        from socartes.services.pocketbase_client import ping_pocketbase
...
app = FastAPI(
    ...
    # See: https://github.com/HKUDS/Socartes/issues/112
...
try:
    from socartes.services.setup import init_user_directories
...
from socartes.api.routers import (
    agent_config,
    attachments,
    auth,
    book,
...
from socartes.multi_user.router import router as multi_user_router  # noqa: E402
...
from socartes.api.routers.auth import require_auth  # noqa: E402
...
@app.get("/")
async def root():
    return {"message": "Welcome to Socartes API"}


if __name__ == "__main__":
    from socartes.api.run_server import main as run_server_main
