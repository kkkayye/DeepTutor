...
Why live here vs inside ``socartes.tutorbot.channels``?
...
from socartes.services.tutorbot.manager import _is_secret_field
...
def all_channel_schemas() -> dict[str, dict[str, Any]]:
    ...
    from socartes.tutorbot.channels.registry import discover_all
