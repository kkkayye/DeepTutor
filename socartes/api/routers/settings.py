...
from socartes.services.config import get_config_test_runner, get_model_catalog_service
...
from socartes.services.model_selection import list_llm_options
...
def _provider_choices() -> dict[str, list[dict[str, str]]]:
    ...
    from socartes.services.provider_registry import PROVIDERS
