...
def _validate_llm_selection_payload(
    ...
    from socartes.services.model_selection import apply_llm_selection_to_catalog
    from socartes.services.tutorbot.model_runtime import normalize_tutorbot_llm_selection
