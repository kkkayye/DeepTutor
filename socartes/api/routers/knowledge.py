...
from socartes.api.utils.progress_broadcaster import ProgressBroadcaster
from socartes.api.utils.task_id_manager import TaskIDManager
from socartes.api.utils.task_log_stream import capture_task_logs, get_task_stream_manager
from socartes.knowledge.add_documents import DocumentAdder
from socartes.knowledge.initializer import KnowledgeBaseInitializer
from socartes.knowledge.manager import KnowledgeBaseManager
from socartes.knowledge.naming import validate_knowledge_base_name
from socartes.knowledge.progress_tracker import ProgressStage, ProgressTracker
from socartes.multi_user.context import get_current_user
from socartes.multi_user.knowledge_access import (
    assert_writable,
    current_kb_base_dir,
    current_kb_manager,
...
def _save_uploaded_files(
    ...
    from socartes.services.pocketbase_client import is_pocketbase_enabled
...
def _upload_file_to_pb(kb_name: str, filename: str, file_path: Path) -> None:
    ...
    try:
        from socartes.services.pocketbase_client import get_pb_client
...
def _matching_index_is_valid(kb_name: str, matching_version: dict | None) -> bool:
    ...
    if not matching_version:
        return False
    try:
        from socartes.services.rag.pipelines.llamaindex.storage import (
...
async def get_all_kb_configs():
    ...
    try:
        from socartes.services.config import get_kb_config_service
...
async def reindex_knowledge_base(
    ...
    try:
        ...
        from socartes.services.rag.embedding_signature import signature_from_embedding_config
...
async def websocket_progress(websocket: WebSocket, kb_name: str):
    ...
    try:
        ...
        from socartes.services.rag.index_versioning import list_kb_versions
