...
class SocartesError(Exception):
    """Base class for all application errors in Socartes."""
...
class ConfigurationError(SocartesError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(SocartesError):
    """Raised when input validation fails."""

    pass


class ServiceError(SocartesError):
