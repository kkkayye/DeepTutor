...
def _load_question_extractor_module():
    ...
    stubbed_modules = {
        "socartes.services.config": {"get_agent_params": lambda *_args, **_kwargs: {}},
        "socartes.services.llm": {"complete": lambda *_args, **_kwargs: None},
        "socartes.services.llm.capabilities": {
            "supports_response_format": lambda *_args, **_kwargs: False
        },
        "socartes.services.llm.config": {"get_llm_config": lambda: None},
        "socartes.utils.json_parser": {"parse_json_response": lambda *_args, **_kwargs: {}},
    }
