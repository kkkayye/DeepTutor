"""CLI smoke tests for ``socartes notebook`` commands."""
...
def _patch_facade(monkeypatch) -> None:
    """Patch SocartesApp methods to use the shared fake manager."""
    ...
    from socartes.app import facade

    monkeypatch.setattr(facade.SocartesApp, "create_notebook", _create_notebook)
    monkeypatch.setattr(facade.SocartesApp, "get_notebook", _get_notebook)
    monkeypatch.setattr(facade.SocartesApp, "add_record", _add_record)
    monkeypatch.setattr(facade.SocartesApp, "update_record", _update_record)
    monkeypatch.setattr(facade.SocartesApp, "remove_record", _remove_record)
