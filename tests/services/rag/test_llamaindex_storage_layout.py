...
from socartes.services.rag.index_versioning import EmbeddingSignature
...
async def test_incremental_add_migrates_matching_legacy_index_to_flat_version(
    ...
    from socartes.services.rag.pipelines.llamaindex.pipeline import LlamaIndexPipeline
