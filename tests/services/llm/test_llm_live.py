...
async def run_test(
    *,
    ...
    from socartes.services.llm import config as config_module
    ...
    try:
        from socartes.services.llm.factory import complete

        t0 = time.perf_counter()
        resp = await complete(
            "Reply with exactly: HELLO_SOCARTES",
    ...
    if test_stream:
        ...
        try:
            from socartes.services.llm.factory import stream
