...
AGENTS_DIR = PROJECT_ROOT / "socartes" / "agents"
# Modules that live outside socartes/agents/ but still own prompts.
EXTRA_PROMPT_MODULE_DIRS = (
    PROJECT_ROOT / "socartes" / "book",
    PROJECT_ROOT / "socartes" / "co_writer",
)
