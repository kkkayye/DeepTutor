"""CLI entry point for the standalone ``socartes-cli`` package."""
...
from socartes.runtime.mode import RunMode, set_mode
from socartes.services.setup import get_backend_port
...
app = typer.Typer(
    name="socartes",
    help="Socartes CLI – agent-first interface for capabilities, tools, and knowledge.",
...
def run_capability(
    ...
    from socartes.app import SocartesApp
    ...
    maybe_run(run_turn_and_render(app=SocartesApp(), request=request, fmt=fmt))
